    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      ...
      >
        ...
        <motion.button
          ...
          className="inline-flex items-center px-8 py-4 bg-slate-600 text-white text-lg font-medium rounded-lg hover:bg-slate-700 transition-all duration-200 shadow-sm hover:shadow-md transform hover:scale-105"
        >
